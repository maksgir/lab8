...
public class AddController {
    ...
    public AddController(ClientWorker clientWorker, String type) {
    ...
    void addRoute(ActionEvent event) {
        ...
        Command command = new Command(clientWorker.getUser(), this.type, route);

        Request request = RequestCreator.createCommandWithRouteRequest(command);
    ...
    private Route generateRoute() {
        try {
            ...
            route.setOwner(clientWorker.getUser().getLogin());
            return route;
